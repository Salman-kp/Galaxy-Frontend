...
const EventCard = ({ event, onClick, variant }) => {
  ...
  // Helper to format "08:00" to "8:00 AM"
  ...
  // Themes for Action-based pages (Booked, Ongoing, Completed)
  const theme = {
  ongoing: "bg-gradient-to-r from-amber-500 to-orange-600 text-white", // More "active" feel
  booked: "bg-gradient-to-r from-[#1b5e20] to-[#2e7d32] text-white shadow-[0_8px_20px_rgba(27,94,32,0.2)]", // Deep emerald gradient
  completed: "bg-slate-100 text-slate-500 border border-slate-200", // Muted for finished tasks
};
